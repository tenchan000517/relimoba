    ...
    >
      <div className="container mx-auto max-w-4xl">
        ...
        <div className={`mb-4 transition-all duration-1000 ${animatedElements.plans ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          <div className="bg-blue-500 text-white rounded-t-lg p-6">
            <div className="flex justify-center items-center mb-2">
              <span className="text-xl font-bold mr-2">トークン＋</span>
              <span className="bg-white text-blue-500 px-2 py-0.5 rounded text-sm font-bold">モバイル</span>
            </div>
            <div className="flex justify-center items-center">
              ...
              <span className="text-4xl font-bold">格安SIM</span>
            </div>
          </div>
        ...
        <div className={`mb-4 transition-all duration-1000 delay-300 ${animatedElements.plans ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          <div className="bg-blue-500 text-white rounded-t-lg p-6">
            ...
            <div className="flex justify-center items-center">
              ...
              <span className="text-4xl font-bold">格安WiFi</span>
            </div>
          </div>

          <div className="bg-white shadow-md">
            <div className="px-4 py-8">
              <div className="rounded-4xl bg-gray-100 flex flex-col p-2 px-6 shadow-md mx-auto">
