        ...
        if (inView) {
            ...
            if (!scrollingDown) {
                ...
                const timers = [
                    ...
                    setTimeout(() => setAnimatedElements(prev => ({ ...prev, image2: true })), 700),
                    setTimeout(() => setAnimatedElements(prev => ({ ...prev, benefits: true })), 900),
    ...
    return (
        ...
        >
            <div className="container mx-auto max-w-6xl">
                ...
                {/* 説明文 - 画像①の下に移動 */}
                <div className={`text-center mb-12 transition-all duration-1000 ${animatedElements.subtitle ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
