    ...
    if (sectionInView) {
      ...
      if (!scrollingDown) {
        ...
        const animationTimers = [
          ...
          setTimeout(() => setAnimatedElements(prev => ({ ...prev, referral: true })), 1700), // 追加したカードのアニメーション
          setTimeout(() => setAnimatedElements(prev => ({ ...prev, sticker: true })), 1900),
          setTimeout(() => setAnimatedElements(prev => ({ ...prev, cta: true })), 2100),
        ];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        ...
        {/* Feature Cards - PCでは3カラムのレイアウトに変更 */}
